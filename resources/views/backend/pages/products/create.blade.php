...
@endsection
@section('content')
    {!! Form::open(array('id'=>'form','url'=>'/shopping-frpi/backend/products/store','method'=>'POST','enctype'=>"multipart/form-data")) !!}
        <div class="page-title">
            <div class="title_left">
                <h3>Products&nbsp;&nbsp;<small style="font-size: 50%;"> Catalog / </small><small style="font-size: 50%;"> Product / </small><small style="font-size: 50%;color:#1e91cf;">Add New</small></h3>
            </div>
                            ...
                            <div class="nav-tabs-custom">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="tab_2">
                                        @include('backend.pages.products.forms.data')
                                    </div>
