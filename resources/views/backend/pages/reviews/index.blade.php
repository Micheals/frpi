...
@section('content')
    <div class="page-title">
        <div class="title_left">
            <h3>Reviews&nbsp;&nbsp;<small style="font-size: 50%;">Catalog / </small><small style="font-size: 50%;color:#1e91cf;"> Reviews</small></h3>
        </div>
        <div class="title_right">
            <a href="/shopping-frpi/backend/reviews/create" class="btn btn-primary" style="float: right;"><i class="fa fa-plus"></i> Add New </a>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2><i class="fa fa-list"></i> Reviews List<small>reviews table list</small></h2>
                ...
                <div class="x_content">
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <th class="col-md-1 text-center"><b>Rates</b></th>
                            <th class="col-md-6 text-left">Testimonial</th>
                            ...
                            <tr>
                                <td class="text-center">
                                    @foreach($review->products as $product)
                                        <img src="{!! url($product->data->image)!!}" class="img-responsive center-block" height="80" width="80">
                                    @endforeach
                                </td>
                                <td>{!! $review->author !!}</td>
                                <td class="text-center">{!! $review->ratings !!}</td>
                                <td class="text-left">{!! $review->text !!}</td>
                                <td class="text-center"><a href="/shopping-frpi/backend/reviews/edit/{{$review->id}}"><i class="fa fa-edit"></i></a></td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
