...
@endsection
@section('content')
	{!! Form::model($category,array('id'=>'form','url'=>'/shopping-frpi/backend/category/update','method'=>'POST')) !!}
	{!! Form::hidden('id',$category->id) !!}
	<div class="page-title">
		<div class="title_left">
			<h3>Categories&nbsp;&nbsp;<small style="font-size: 50%;">Catalog / </small><small style="font-size: 50%;"> Categories / </small><small style="font-size: 50%;color:#1e91cf;">Edit</small></h3>
		</div>
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				<div class="x_title">
					<h2><i class="fa fa-pencil"></i> Edit Category<small>Edit {!! $category->name !!} </small></h2>
