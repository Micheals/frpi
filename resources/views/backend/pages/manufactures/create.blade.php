...
@endsection
@section('content')
    {!! Form::open(array('id'=>'form','url'=>'/shopping-frpi/backend/manufacture/store','method'=>'POST','enctype'=>"multipart/form-data")) !!}
    <div class="page-title">
        <div class="title_left">
            <h3>Manufacturers&nbsp;&nbsp;<small style="font-size: 50%;">Catalog / </small><small style="font-size: 50%;"> Manufacturers / </small><small style="font-size: 50%;color:#1e91cf;">Add New</small></h3>
        </div>
